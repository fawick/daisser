var map, featureList, positionSearch = []
...
function syncSidebar() {
  ...
  positions.eachLayer(function (layer) {
    if (map.hasLayer(positionsLayer)) {
...
//var last24hours = L.geoJson(null, {
...
//      },
//      mouseout: function (e) {
//        last24hours.resetStyle(e.target);
//      }
//    });
//  }
//});
//$.getJSON("/api/last24hours.geojson", function (data) {
//  last24hours.addData(data);
//});
...
var positionsLayer = L.geoJson(null);
var positions = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.User + "</td></tr>" + "<tr><th>Client</th><td>" + feature.properties.Client + "</td></tr>" + "<tr><th>Tracker</th><td>" + feature.properties.Tracker + "</td></tr></a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/theater.png"></td><td class="feature-name">' + layer.feature.properties.User + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      positionSearch.push({
        name: layer.feature.properties.User,
        address: layer.feature.properties.Client,
        source: "Positions",
        id: L.stamp(layer),
...
map = L.map("map", {
  zoom: 10,
  center: [50, 8.56],
  layers: [mapquestOSM, markerClusters, positionsLayer, highlight],
  zoomControl: false,
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='assets/img/theater.png' width='24' height='28'>&nbsp;Positions": positionsLayer,
  },
  //"History": {
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/theater.png' width='24' height='28'>&nbsp;Positions</h4>",
